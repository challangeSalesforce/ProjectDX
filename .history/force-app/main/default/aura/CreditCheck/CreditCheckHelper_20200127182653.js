({
    // Method used to get the picklist values for Status, Origin, Priority, Credit Check Status
    ...
    //Method used to save the Case related to the Account record
    ...
    // Used for cancel, close the modal
    closeModal : function() {
